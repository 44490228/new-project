...
function NooraniQaidaCard2() {
  ...
  return (
    <Card className="card-home">
      <Card.Img
        variant="top"
        src="/Images/2.png" // Replace with your image URL
        alt="Noorani Qaida"
      ...
      <Card.Body style={{ padding: "10px 15px" }}>
        <Card.Title style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0" }}>
          <span style={{ fontSize: "18px", fontWeight: "bold", color: "#00796b" }}>Quran Reading</span>
          <Button
            variant="link"
        ...
        <Collapse in={open}>
          ...
          Quran Reading helps learners improve fluency and accuracy in reciting the Quran with proper tajweed.
          </div>
        </Collapse>
      </Card.Body>
    </Card>
...
export default NooraniQaidaCard2;
