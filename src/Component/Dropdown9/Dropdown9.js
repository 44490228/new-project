...
function NooraniQaidaCard9() {
  ...
  return (
    <Card className="card-home">
      <Card.Img
        variant="top"
        src="/Images/subject-img.png" // Replace with your image URL
        alt="Noorani Qaida"
      ...
      <Card.Body style={{ padding: "10px 15px" }}>
        <Card.Title style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0" }}>
          <span style={{ fontSize: "18px", fontWeight: "bold", color: "#00796b" }}>subject</span>
          <Button
            variant="link"
...
export default NooraniQaidaCard9;
